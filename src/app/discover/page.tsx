    ...
    <>
      <article className={`min-h-screen w-full`}>
        <section className="w-full">
          ...
          <Box className="w-full flex flex-col items-start first:items-start justify-center">
            <TextField
              className="border border-[#C4C4C4] rounded text-[#A0A1A5] mb-6 py-4 px-3 w-full md:w-[723px] h-[56px]"
              type="text"
              placeholder="Buscar tags"
            />
            <Box className="w-full lg:max-w-[1120px] flex flex-col items-center justify-center md:grid md:grid-cols-2 md:place-items-center lg:grid lg:grid-cols-3 lg:place-items-start lg:justify-between gap-6 mt-10">
